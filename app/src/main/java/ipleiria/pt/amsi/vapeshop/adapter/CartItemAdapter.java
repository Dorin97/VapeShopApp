...
public class CartItemAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            tvName = (TextView) convertView.findViewById(R.id.tvCartItemNome);
            tvUnitPrice = (TextView) convertView.findViewById(R.id.tvCartItemPrecoUni);
            tvQuantity = (TextView) convertView.findViewById(R.id.tvCartItemQuantidade);
            tvPrice = (TextView) convertView.findViewById(R.id.tvCartItemPreco);
